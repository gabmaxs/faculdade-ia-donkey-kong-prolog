...
solucao(Inicial, ListaEscadas, ListaParedes, ListaBarril, Martelo, Peach, Solucao) :-
...
busca_largura([[Posicao|Caminho]|_], _, _, _, Destino, [Posicao|Caminho]) :- Posicao = Destino, Caminho \= [].
